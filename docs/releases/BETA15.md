...
`BETA15` preserves the project after the larger timeline manipulation pass that
followed the earlier `BETA14` cleanup snapshot.
...
At `BETA15`, the timeline is materially stronger in four practical ways:
...
- latest `adb install -r .../app-debug.apk` completed on the connected device
  ...
  - `lastUpdateTime = 2026-04-11 03:58:27`
