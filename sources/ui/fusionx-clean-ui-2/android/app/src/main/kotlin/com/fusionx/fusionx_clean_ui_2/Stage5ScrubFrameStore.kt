...
data class Stage5ScrubFrameStoreStatus(
    ...
    val overviewFrameIntervalMs: Int,
    val overviewFrameCount: Int,
    val overviewExtractedFrameCount: Int,
    val activeWindowStartMs: Long?,
    val activeWindowEndMs: Long?,
    val activeWindowFrameCount: Int,
    val activeWindowReadyFrameCount: Int,
    val isActiveWindowReady: Boolean,
    ...
    fun toMap(): Map<String, Any?> =
        mapOf(
            ...
            "overviewFrameIntervalMs" to overviewFrameIntervalMs,
            "overviewFrameCount" to overviewFrameCount,
            "overviewExtractedFrameCount" to overviewExtractedFrameCount,
            "activeWindowStartMs" to activeWindowStartMs,
            "activeWindowEndMs" to activeWindowEndMs,
            "activeWindowFrameCount" to activeWindowFrameCount,
            "activeWindowReadyFrameCount" to activeWindowReadyFrameCount,
            "isActiveWindowReady" to isActiveWindowReady,
            "hasRenderablePreview" to hasRenderablePreview,
