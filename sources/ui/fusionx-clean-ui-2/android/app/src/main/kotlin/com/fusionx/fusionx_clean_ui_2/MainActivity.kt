        ...
        MethodChannel(
            ...
            when (call.method) {
                ...
                "planFrameSamples" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planFrameSamples(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
                ...
                "planVideoSourceProbe" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planVideoSourceProbe(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
                ...
                "planRenderPassGraph" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planRenderPassGraph(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
                ...
                "planSurfaceRenderer" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planSurfaceRenderer(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
                ...
                "planFrameRenderCommands" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planFrameRenderCommands(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
                ...
                "planParityOutputs" -> {
                    ...
                    val timelineTimeMs = (request?.get("timelineTimeMs") as? Number)?.toLong()
                    result.success(
                        professionalVideoTransitionCompositorManager.planParityOutputs(
                            plan = request,
                            timelineTimeMs = timelineTimeMs,
                        ),
                    )
