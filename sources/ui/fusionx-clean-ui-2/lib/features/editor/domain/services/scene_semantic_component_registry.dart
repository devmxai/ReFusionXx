...
class SceneSemanticComponentRegistry {
  ...
  List<String> get supportedComponentIds {
    final ids = _definitions.keys.toList(growable: false)..sort();
    return ids;
  }
...
final Map<String, SceneSemanticComponentDefinition> _defaultDefinitions =
  ...
  'SearchBar': SceneSemanticComponentDefinition(
    id: 'SearchBar',
    aliases: const <String>{'search-bar'},
    requiredSlots: const <String>{'queryText'},
    optionalSlots: const <String>{
      'leadingIcon',
      'trailingAction',
      'placeholder',
    },
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'queryText': SceneSemanticSlotDefinition(
        id: 'queryText',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ...
      'trailingAction': SceneSemanticSlotDefinition(
        id: 'trailingAction',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'placeholder': SceneSemanticSlotDefinition(
  ...
  'TextField': SceneSemanticComponentDefinition(
    id: 'TextField',
    aliases: const <String>{'text-field'},
    requiredSlots: const <String>{'valueText'},
    optionalSlots: const <String>{
      'leadingIcon',
      'trailingIcon',
      'helper',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'valueText': SceneSemanticSlotDefinition(
        id: 'valueText',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ...
      'helper': SceneSemanticSlotDefinition(
        id: 'helper',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _shapeAndTextNodes,
  ...
  'HeroSection': SceneSemanticComponentDefinition(
    id: 'HeroSection',
    aliases: const <String>{'hero-section'},
    requiredSlots: const <String>{'headline', 'subheadline'},
    optionalSlots: const <String>{
      'media',
      'ctaPrimary',
      'ctaSecondary',
    ...
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'headline': SceneSemanticSlotDefinition(
        id: 'headline',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ),
      'subheadline': SceneSemanticSlotDefinition(
        id: 'subheadline',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ...
      'ctaPrimary': SceneSemanticSlotDefinition(
        id: 'ctaPrimary',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'ctaSecondary': SceneSemanticSlotDefinition(
        id: 'ctaSecondary',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'badge': SceneSemanticSlotDefinition(
  ...
  'StatCard': SceneSemanticComponentDefinition(
    id: 'StatCard',
    aliases: const <String>{'stat-card'},
    requiredSlots: const <String>{'label', 'value'},
    optionalSlots: const <String>{'delta', 'icon', 'badge'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'value': SceneSemanticSlotDefinition(
        id: 'value',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ),
      'delta': SceneSemanticSlotDefinition(
        id: 'delta',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _shapeAndTextNodes,
  ...
  'TestimonialCard': SceneSemanticComponentDefinition(
    id: 'TestimonialCard',
    aliases: const <String>{'testimonial-card'},
    requiredSlots: const <String>{'quote', 'author'},
    optionalSlots: const <String>{'avatar', 'role', 'brand'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'FeatureGrid',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'quote': SceneSemanticSlotDefinition(
        id: 'quote',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ),
      'author': SceneSemanticSlotDefinition(
        id: 'author',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ),
      'avatar': SceneSemanticSlotDefinition(
        id: 'avatar',
        allowedNodeTypes: <SceneSemanticRuntimeNodeType>{
          SceneSemanticRuntimeNodeType.image,
          SceneSemanticRuntimeNodeType.icon,
      ...
      'role': SceneSemanticSlotDefinition(
        id: 'role',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _textNodes,
      ),
      'brand': SceneSemanticSlotDefinition(
        id: 'brand',
        allowedNodeTypes: _iconNodes,
      ),
    },
  ...
  'ProductCard': SceneSemanticComponentDefinition(
    id: 'ProductCard',
    aliases: const <String>{'product-card'},
    requiredSlots: const <String>{'title', 'price'},
    optionalSlots: const <String>{'image', 'description', 'badge', 'cta'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'FeatureGrid',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'price': SceneSemanticSlotDefinition(
        id: 'price',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ),
      'image': SceneSemanticSlotDefinition(
        id: 'image',
        allowedNodeTypes: <SceneSemanticRuntimeNodeType>{
          SceneSemanticRuntimeNodeType.image,
          SceneSemanticRuntimeNodeType.video,
      ...
      'description': SceneSemanticSlotDefinition(
        id: 'description',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
  ...
  'ImageCard': SceneSemanticComponentDefinition(
    id: 'ImageCard',
    aliases: const <String>{'image-card'},
    requiredSlots: const <String>{'image', 'title'},
    optionalSlots: const <String>{'caption', 'badge'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'FeatureGrid',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'caption': SceneSemanticSlotDefinition(
        id: 'caption',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
  ...
  'FAB': SceneSemanticComponentDefinition(
    id: 'FAB',
    aliases: const <String>{'fab', 'floating-action-button'},
    requiredSlots: const <String>{'icon'},
    optionalSlots: const <String>{'label', 'badge'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
  ...
  'ToggleButton': SceneSemanticComponentDefinition(
    id: 'ToggleButton',
    aliases: const <String>{'toggle-button'},
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'stateIndicator': SceneSemanticSlotDefinition(
        id: 'stateIndicator',
        allowedNodeTypes: _shapeAndTextNodes,
      ),
    },
  ...
  'FeatureGrid': SceneSemanticComponentDefinition(
    id: 'FeatureGrid',
    aliases: const <String>{'feature-grid'},
    requiredSlots: const <String>{'cellA', 'cellB'},
    optionalSlots: const <String>{'cellC', 'cellD', 'header', 'footer'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'cellA': SceneSemanticSlotDefinition(
        id: 'cellA',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'cellB': SceneSemanticSlotDefinition(
        id: 'cellB',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'cellC': SceneSemanticSlotDefinition(
        id: 'cellC',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'cellD': SceneSemanticSlotDefinition(
        id: 'cellD',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'header': SceneSemanticSlotDefinition(
  ...
  'FeatureList': SceneSemanticComponentDefinition(
    id: 'FeatureList',
    aliases: const <String>{'feature-list'},
    requiredSlots: const <String>{'itemA', 'itemB'},
    optionalSlots: const <String>{'itemC', 'itemD', 'title'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'itemA': SceneSemanticSlotDefinition(
        id: 'itemA',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'itemB': SceneSemanticSlotDefinition(
        id: 'itemB',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'itemC': SceneSemanticSlotDefinition(
        id: 'itemC',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'itemD': SceneSemanticSlotDefinition(
        id: 'itemD',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'title': SceneSemanticSlotDefinition(
  ...
  'BrandLogo': SceneSemanticComponentDefinition(
    id: 'BrandLogo',
    aliases: const <String>{'brand-logo'},
    requiredSlots: const <String>{'logo'},
    optionalSlots: const <String>{'wordmark', 'tagline'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'HeroSection',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'logo': SceneSemanticSlotDefinition(
        id: 'logo',
        allowedNodeTypes: <SceneSemanticRuntimeNodeType>{
          SceneSemanticRuntimeNodeType.icon,
          SceneSemanticRuntimeNodeType.image,
      ...
      'wordmark': SceneSemanticSlotDefinition(
        id: 'wordmark',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _textNodes,
      ),
      'tagline': SceneSemanticSlotDefinition(
        id: 'tagline',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _textNodes,
  ...
  'AvatarBadge': SceneSemanticComponentDefinition(
    id: 'AvatarBadge',
    aliases: const <String>{'avatar-badge'},
    requiredSlots: const <String>{'avatar'},
    optionalSlots: const <String>{'label', 'status'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'TestimonialCard',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'status': SceneSemanticSlotDefinition(
        id: 'status',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _shapeAndTextNodes,
  ...
  'Toast': SceneSemanticComponentDefinition(
    id: 'Toast',
    aliases: const <String>{'toast'},
    requiredSlots: const <String>{'message'},
    optionalSlots: const <String>{'leadingIcon', 'action'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'message': SceneSemanticSlotDefinition(
        id: 'message',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
      ...
      'action': SceneSemanticSlotDefinition(
        id: 'action',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
    },
  ...
  'AlertCard': SceneSemanticComponentDefinition(
    id: 'AlertCard',
    aliases: const <String>{'alert-card'},
    requiredSlots: const <String>{'title', 'body'},
    optionalSlots: const <String>{'leadingIcon', 'actions', 'severityBadge'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'actions': SceneSemanticSlotDefinition(
        id: 'actions',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'severityBadge': SceneSemanticSlotDefinition(
        id: 'severityBadge',
        allowedNodeTypes: _shapeAndTextNodes,
      ),
    },
  ...
  'ProgressIndicator': SceneSemanticComponentDefinition(
    id: 'ProgressIndicator',
    aliases: const <String>{'progress-indicator'},
    requiredSlots: const <String>{'track'},
    optionalSlots: const <String>{'label', 'value', 'icon'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'track': SceneSemanticSlotDefinition(
        id: 'track',
        allowedNodeTypes: _shapeNodes,
      ),
      'label': SceneSemanticSlotDefinition(
        id: 'label',
        acceptsText: true,
  ...
  'VideoPlayer': SceneSemanticComponentDefinition(
    id: 'VideoPlayer',
    aliases: const <String>{'video-player'},
    requiredSlots: const <String>{'viewport'},
    optionalSlots: const <String>{'controls', 'title', 'subtitle', 'progress'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'viewport': SceneSemanticSlotDefinition(
        id: 'viewport',
        allowedNodeTypes: <SceneSemanticRuntimeNodeType>{
          SceneSemanticRuntimeNodeType.video,
          SceneSemanticRuntimeNodeType.image,
      ...
      'controls': SceneSemanticSlotDefinition(
        id: 'controls',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'title': SceneSemanticSlotDefinition(
      ...
      'progress': SceneSemanticSlotDefinition(
        id: 'progress',
        allowedNodeTypes: _shapeAndTextNodes,
      ),
    },
  ...
  'AudioWaveform': SceneSemanticComponentDefinition(
    id: 'AudioWaveform',
    aliases: const <String>{'audio-waveform', 'waveform'},
    requiredSlots: const <String>{'waveform'},
    optionalSlots: const <String>{'label', 'timer', 'controls'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'DashboardPanel',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'waveform': SceneSemanticSlotDefinition(
        id: 'waveform',
        allowedNodeTypes: _shapeNodes,
      ),
      'label': SceneSemanticSlotDefinition(
      ...
      'timer': SceneSemanticSlotDefinition(
        id: 'timer',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _textNodes,
  ...
  'ColorGradePanel': SceneSemanticComponentDefinition(
    id: 'ColorGradePanel',
    aliases: const <String>{'color-grade-panel'},
    requiredSlots: const <String>{'surface'},
    optionalSlots: const <String>{
      'title',
      'histogram',
      'sliderA',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'surface': SceneSemanticSlotDefinition(
        id: 'surface',
        allowedNodeTypes: _shapeNodes,
      ),
      'title': SceneSemanticSlotDefinition(
      ...
      'histogram': SceneSemanticSlotDefinition(
        id: 'histogram',
        allowedNodeTypes: _shapeNodes,
      ),
      'sliderA': SceneSemanticSlotDefinition(
        id: 'sliderA',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'sliderB': SceneSemanticSlotDefinition(
        id: 'sliderB',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'sliderC': SceneSemanticSlotDefinition(
        id: 'sliderC',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
    },
  ...
  'KineticTitle': SceneSemanticComponentDefinition(
    id: 'KineticTitle',
    aliases: const <String>{'kinetic-title'},
    requiredSlots: const <String>{'headline'},
    optionalSlots: const <String>{'highlight', 'subtitle'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'headline': SceneSemanticSlotDefinition(
      ...
      'highlight': SceneSemanticSlotDefinition(
        id: 'highlight',
        acceptsText: true,
        requiresBoundedText: true,
        allowedNodeTypes: _textNodes,
  ...
  'TypingPrompt': SceneSemanticComponentDefinition(
    id: 'TypingPrompt',
    aliases: const <String>{'typing-prompt'},
    requiredSlots: const <String>{'shell', 'text'},
    optionalSlots: const <String>{'caret', 'leadingIcon', 'trailingIcon'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      'shell': SceneSemanticSlotDefinition(
        id: 'shell',
        allowedNodeTypes: _shapeNodes,
      ),
      ...
      'caret': SceneSemanticSlotDefinition(
        id: 'caret',
        allowedNodeTypes: _shapeAndTextNodes,
      ),
      'leadingIcon': SceneSemanticSlotDefinition(
  ...
  'QuoteBlock': SceneSemanticComponentDefinition(
    id: 'QuoteBlock',
    aliases: const <String>{'quote-block'},
    requiredSlots: const <String>{'quote'},
    optionalSlots: const <String>{'attribution', 'accent'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{
      kSceneSemanticRootParentType,
      'FeatureCard',
    ...
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'attribution': SceneSemanticSlotDefinition(
        id: 'attribution',
        acceptsText: true,
        requiresBoundedText: false,
        allowedNodeTypes: _textNodes,
      ),
      'accent': SceneSemanticSlotDefinition(
        id: 'accent',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
    },
  ...
  'OrbitalRing': SceneSemanticComponentDefinition(
    id: 'OrbitalRing',
    aliases: const <String>{'orbital-ring', 'ring-orbit'},
    requiredSlots: const <String>{'centerLabel', 'ring', 'nodeA', 'nodeB'},
    optionalSlots: const <String>{'nodeC', 'nodeD'},
    allowedVariants: _defaultVariants,
    allowedParentTypes: const <String>{kSceneSemanticRootParentType},
    slotDefinitions: const <String, SceneSemanticSlotDefinition>{
      ...
      'ring': SceneSemanticSlotDefinition(
        id: 'ring',
        allowedNodeTypes: _shapeNodes,
      ),
      'nodeA': SceneSemanticSlotDefinition(
        id: 'nodeA',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'nodeB': SceneSemanticSlotDefinition(
        id: 'nodeB',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'nodeC': SceneSemanticSlotDefinition(
        id: 'nodeC',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
      'nodeD': SceneSemanticSlotDefinition(
        id: 'nodeD',
        allowedNodeTypes: _shapeIconTextNodes,
      ),
    },
