...
void main() {
  test('builds native preflight payload with descriptors and parity report', () {
    final result = LiveScrubDescriptorProjectionResult(
      ...
      parityReport: const LiveScrubParityReport(
        ...
        transitionParityState: LiveScrubTransitionParityState.windowReadyNoPixels,
    ...
    final payload = buildLiveScrubDescriptorPreflightPayload(result);
